...
public class Characters extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.character_fragment);

		Account slick50zd1 = new Account(
				892477,
				"vuywVBKCvhIuYT8xx1dx1YljvxFUj6x8JRrKkVNqGkbROXwchQb3eTrI3rC92u0s",
				this);
	 ...
	 * 
	 */
	private class GetCharacters extends
			AsyncTask<Account, Integer, ArrayList<EveCharacter>> {
