...
public class StationDatabase {
	...
	public void insertStationInfo(Set<Object> dataSet) {
		StationInfo[] stationInfoArray = new StationInfo[dataSet.size()];

		int i = 0;
		for(Object typeInfo : dataSet) {
			stationInfoArray[i] = (StationInfo) typeInfo;
			i++;
		}

		insertStationInfo(stationInfoArray);
	}
	...
	private class CustomSQLiteOpenHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			String newTableQueryString = "create table " + TABLE_NAME + " (" + TABLE_ROW_ID + " integer primary key not null," + TABLE_ROW_STATIONTYPEID + " integer," + TABLE_ROW_STATIONNAME + " text," + "UNIQUE (" + TABLE_ROW_ID + ") ON CONFLICT REPLACE);";
