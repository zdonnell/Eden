...
public class ConquerableStationsTask extends AsyncTask<Void, Void, SkillTreeResponse> implements IApiTask<SkillTreeResponse>
{
	...
	public ConquerableStationsTask(APIExceptionCallback<SkillTreeResponse> callback, Context context)
	{
