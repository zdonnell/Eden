...
public class CharacterDB {
	 ...
	 */
	public void addCharacter(String name, int corpID)
	{
		// this is a key value pair holder used by android's SQLite functions
		ContentValues values = new ContentValues();
		values.put(CHAR_TABLE_NAME, name);
		values.put(CHAR_TABLE_CORPID, corpID);
	...
	public Cursor allCharacters()
	{
		...
		try
		{
			...
			cursor = db.query(
					CHAR_TABLE_NAME,
					new String[] { CHAR_TABLE_NAME, CHAR_TABLE_EVEID, CHAR_TABLE_CORPID },
	...
	private class CustomSQLiteOpenHelper extends SQLiteOpenHelper
	{
		...
		public void onCreate(SQLiteDatabase db)
		{
			...
			String newTableQueryString = "create table " +
										CHAR_TABLE_NAME +
										" (" +
										CHAR_TABLE_ID + " integer primary key autoincrement not null," +
										CHAR_TABLE_NAME + " string," +
										CHAR_TABLE_EVEID + " integer," +
