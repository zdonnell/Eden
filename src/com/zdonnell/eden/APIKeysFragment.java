...
public class APIKeysFragment extends Fragment {
    ...
    private void getData() {
        ...
        while (c.moveToNext()) {
            ...
            if (!doesAPIKeyExistInList(apiKey, vCode, apiCredsList))
                apiCredsList.add(new ApiAuthorization(apiKey, vCode));

            if (characters.get(apiKey) == null)
                characters.put(apiKey, new ArrayList<EveCharacter>());
