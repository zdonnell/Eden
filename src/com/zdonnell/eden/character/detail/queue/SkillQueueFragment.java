package com.zdonnell.eden.character.detail.queue;
...
import com.zdonnell.eden.helpers.TimeRemainingCountdown;
		...
		private void setTextElements(View mainView, final ApiSkillQueueItem queuedSkill) {
			...
			new StaticData(context).getStaticData(new ApiCallback<SparseArray<TypeInfo>>((ILoadingActivity) getActivity()) {
				...
				public void onUpdate(SparseArray<TypeInfo> updatedData) {
					if (updatedData.valueAt(0) == null)
						skillName.setText("Skill ID: " + queuedSkill.getTypeID());
