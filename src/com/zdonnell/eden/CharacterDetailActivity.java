...
import com.zdonnell.eden.character.detail.InventorySort;
import com.zdonnell.eden.character.detail.assets.InventoryListFragment;
import com.zdonnell.eden.character.detail.assets.ParentAssetsFragment;
import com.zdonnell.eden.character.detail.attributes.AttributesFragment;
import com.zdonnell.eden.character.detail.queue.SkillQueueFragment;
import com.zdonnell.eden.character.detail.skills.SkillsFragment;
...
public class CharacterDetailActivity extends NavDrawerActivity implements ActionBar.TabListener {
	...
	public class SectionsPagerAdapter extends FragmentStatePagerAdapter {
		...
		public ParentAssetsFragment assetsFragment() {
			return assetsFragment;
		}

		private SkillsFragment skillsFragment;

		public SkillsFragment skillsFragment() {
		...
		public SkillQueueFragment skillQueueFragment() {
			return skillQueueFragment;
		}
	...
	private class SearchQueryUpdatedListener implements OnQueryTextListener {
		...
		private void ifStillOnAssetsSearch(String searchString) {
			if (mViewPager.getCurrentItem() == CharacterSheetFragment.ASSETS) {
				ParentAssetsFragment assetsFragment = mSectionsPagerAdapter.assetsFragment();
				if (assetsFragment.currentAssets != null)
