...
public class CheckServerDataTask extends AsyncTask<Void, Void, Void> {
     ...
     *
     * @param newDBVersion the database version for the data on the server
     * @param table        the Table that needs to be downloaded.
     * @see IStaticDataType
     */
     ...
     * @param data       the object to check for the fieldName in
     * @param jsonReader the jsonReader which should be pointing to the next available
     *                   value.
